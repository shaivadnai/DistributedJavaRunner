...
public class Message {
    ...
    public Message(MessageType type, byte[] contents, String senderHost, int senderPort, String receiverHost,
            int receiverPort) {
    ...
    public Message(MessageType type, byte[] contents, String senderHost, int senderPort, String receiverHost,
            int receiverPort, long requestID) {
    ...
    public Message(MessageType type, byte[] contents, String senderHost, int senderPort, String receiverHost,
            int receiverPort, long requestID, boolean errorOccurred) {
        this(type, contents, senderHost, senderPort, receiverHost, receiverPort);
        this.requestID = requestID;
    ...
    public String toString(){
        if(this.stringRepresentation == null){
            ...
            if(getMessageType() == MessageType.ELECTION){
                ...
                builder.append("Gossip Payload:");
                List<GossipEntry> gossips = bytesToGossips(getMessageContents());
                for(GossipEntry ge : gossips){
                    builder.append("\n\t" + ge.toString());
                }
            }else{
